...
Breadcrumb.propTypes = {
	 ...
	 */
	isToHome: PropTypes.oneOfType([PropTypes.string, PropTypes.node as Validator<ReactNode>]),
	/**
	 * Icon component or string
	 */
	// @ts-ignore
	divider: PropTypes.oneOfType([PropTypes.string, PropTypes.node as Validator<ReactNode>]),
};
// @ts-ignore
