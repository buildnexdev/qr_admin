...
CardLabel.propTypes = {
	...
	pre: PropTypes.node as Validator<ReactNode>,
};
// @ts-ignore
...
export const CardCodeView: FC<ICardCodeViewProps> = memo(
	({ children, language, customStyle, isPrismJs, className }) => {
		...
		return (
			// @ts-ignore
			<SyntaxHighlighter as={(SyntaxHighlighter as unknown as unknown as any)}
				language={language}
				style={atomOneLight}
				customStyle={{
					borderRadius: 13,
...
CardCodeView.propTypes = {
	children: PropTypes.string as Validator<string>,
