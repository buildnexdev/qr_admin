...
const Footer: React.FC = () => {
  return (
    <footer className="app-footer" style={{ padding: '12px', textAlign: 'center', borderTop: '1px solid rgba(0,0,0,0.05)', marginTop: 'auto', background: 'white' }}>
      <p style={{ margin: 0, fontSize: '0.85rem', color: 'var(--text-muted)', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '6px' }}>
